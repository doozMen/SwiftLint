...
def swiftlint_repos():
    ...
    http_archive(
        ...
        sha256 = "07ea5d8fb39ef5e3d33cc1e78384ab1e9c63f025d16d64894cabfe40b14150cc", # SwiftSyntax sha256
        build_file = "@SwiftLint//bazel:SwiftSyntax.BUILD",
        strip_prefix = "swift-syntax-708532237a6fef9e5ca0e33120355e4b698150a1",
        url = "https://github.com/apple/swift-syntax/archive/708532237a6fef9e5ca0e33120355e4b698150a1.tar.gz",
    )
