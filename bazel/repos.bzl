...
def swiftlint_repos():
    ...
    http_archive(
        ...
        sha256 = "bc9659c0b5861cd81e731151a6e61c0ce629dfb766e60915f8dbabe6173b779b", # SwiftSyntax sha256
        build_file = "@SwiftLint//bazel:SwiftSyntax.BUILD",
        strip_prefix = "swift-syntax-44f69680412c7802a7512f4e34f143c210b4dee2",
        url = "https://github.com/apple/swift-syntax/archive/44f69680412c7802a7512f4e34f143c210b4dee2.tar.gz",
    )
