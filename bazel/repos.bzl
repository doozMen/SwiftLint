...
def swiftlint_repos():
    ...
    http_archive(
        ...
        sha256 = "9eb53f259ba14e98f4dac42fe62d83272b917af7a5a349f51a4f58e6d528fbe3", # SwiftSyntax sha256
        build_file = "@SwiftLint//bazel:SwiftSyntax.BUILD",
        strip_prefix = "swift-syntax-13f113e8a180d4cf1b4460d7e3db697cdf3a3fa8",
        url = "https://github.com/apple/swift-syntax/archive/13f113e8a180d4cf1b4460d7e3db697cdf3a3fa8.tar.gz",
    )
