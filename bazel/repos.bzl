...
def swiftlint_repos():
    ...
    http_archive(
        ...
        sha256 = "4979d5264992498039fc39b0fee7b4629f42ccffac250a64eff6b9f660d5eb1a", # SwiftSyntax sha256
        build_file = "@SwiftLint//bazel:SwiftSyntax.BUILD",
        strip_prefix = "swift-syntax-4d300ac622c0afd18dcc296095559eb4909f28d2",
        url = "https://github.com/apple/swift-syntax/archive/4d300ac622c0afd18dcc296095559eb4909f28d2.tar.gz",
    )
