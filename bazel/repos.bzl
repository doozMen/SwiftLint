...
def swiftlint_repos():
    ...
    http_archive(
        ...
        sha256 = "c02051d7c8dd9d6a43c5333406f272221e6deb84e55512dcc9e0da974df69a31", # SwiftSyntax sha256
        build_file = "@SwiftLint//bazel:SwiftSyntax.BUILD",
        strip_prefix = "swift-syntax-f7667e1a0337080923728689f6cd1c05ebea89ad",
        url = "https://github.com/apple/swift-syntax/archive/f7667e1a0337080923728689f6cd1c05ebea89ad.tar.gz",
    )
